...
ClearAllbtn.addEventListener(`click`, () => {
  ...
  const music = new Audio("./music/music5.mp3"); // Boshqa musiqa
  music.play();
});
...
form.addEventListener("submit", (e) => {
  ...
  newdoneButton.addEventListener("click", () => {
    ...
    const music = new Audio("./music/music2.mp3"); // Boshqa musiqa
    music.play();
  });
  ...
  newDeleteButton.addEventListener("click", () => {
    ...
    const music = new Audio("./music/music4.mp3"); // Boshqa musiqa
    music.play();
  });
